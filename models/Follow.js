...
let Follow = function(followedUsername, athorId) {
...
Follow.prototype.validate = async function(action) {
    ...
    if (followedAccount) {
        ...
        this.errors.push("You can not perform that action.")
    }
    ...
    if (action == "delete") {
        if (!doesFollowAlreadyExist) {this.errors.push("You do not already unfollow. ")}
    } 
